...
@EmbeddedKafka( partitions = 2, count=1, controlledShutdown = true, topics={"${kafka.topic.product.request}", "${kafka.topic.product.reply}"}) // partitions=1
@SpringBootTest(properties = "spring.kafka.consumer.bootstrap-servers=${spring.embedded.kafka.brokers}")
//        classes={KafkaConfigForDirectoryServer.class})
