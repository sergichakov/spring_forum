...
-- DROP SEQUENCE IF EXISTS directory_directoryid_seq;
-- create table post
-- (
--     directoryid bigserial
...
--     owner to jira;
--
-- insert into DIRECTORY (dirname, code, title, price)
...
-- insert into POSTS ( post_id, topic_id, post_content)
-- values (1, 1111, 'Root dir'),
--        (2, 2222, 'Sub_dir dir');
----------------------------------------------------------------
