...
//@Disabled
    ...
    void whenGoPostWeb_shouldSendCreatedPostIT() throws ExecutionException, InterruptedException {
        ...
        //act block
        productService.createPost(createProductDto, 1L ); //.createProduct(createProductDto);
        ...
        assertEquals(createProductDto.getPostContent(),postCreatedEvent.getPosts().get(0).getPostContent());//getQuantity(),productCreatedEvent.getQuantity());
...
//        createProductDto.setUserOwnerId(111L);
        ...
        //act block
        productService.listPost(1,1000);//.createPost(createProductDto); //.createProduct(createProductDto);
...
//        createProductDto.setUserOwnerId(111L);
        ...
        //act block
        productService.getPost(UUID.fromString("ffb71828-b077-4a5d-8749-ee394dfa81e0"));//.createPost(createProductDto); //.createProduct(createProductDto);
...
//        assertEquals(1000,productCreatedEvent.getNumberPerPage());
        assertEquals("ffb71828-b077-4a5d-8749-ee394dfa81e0",postGetEvent.getPosts().get(0).getPostId().toString());//getQuantity(),productCreatedEvent.getQuantity());
//        assertEquals(createProductDto.getNumberOfLikes(),productCreatedEvent.getPosts().get(0).getNumberOfLikes());
//        assertEquals(createProductDto.getTopicId(),productCreatedEvent.getPosts().get(0).getTopicId());
//        assertEquals(createProductDto.getUserCreatorId(),productCreatedEvent.getPosts().get(0).getUserCreatorId());
//        assertEquals(createProductDto.getUserOwnerId(),productCreatedEvent.getPosts().get(0).getUserOwnerId());
    ...
    void whenGoPostWeb_shouldSendPutPostsIT() throws ExecutionException, InterruptedException {
        ...
        updatePostDto.setNumberOfLikes(2L);//.setOrder(0L);
        updatePostDto.setTopicId(12345L);
        updatePostDto.setUserCreatorId(100L);
        updatePostDto.setUserOwnerId(111L);
        Post createPost = new Post();
        //act block
        productService.updatePost(UUID.fromString("ffb71828-b077-4a5d-8749-ee394dfa81e0"),updatePostDto,1L);//.createPost(createProductDto); //.createProduct(createProductDto);
        ...
        assertEquals("ffb71828-b077-4a5d-8749-ee394dfa81e0", productUpdateEvent.getPosts().get(0).getPostId().toString());
        assertEquals(updatePostDto.getPostContent(),productUpdateEvent.getPosts().get(0).getPostContent());//getQuantity(),productCreatedEvent.getQuantity());
    ...
    void whenGoPostWeb_shouldSendDeletePostsIT() throws ExecutionException, InterruptedException {
        ...
        //act block
        productService.deletePost(UUID.fromString("ffb71828-b077-4a5d-8749-ee394dfa81e0"),1L);//.createPost(createProductDto); //.createProduct(createProductDto);
        ...
        assertEquals("ffb71828-b077-4a5d-8749-ee394dfa81e0", postDeleteEvent.getPosts().get(0).getPostId().toString());
    }
